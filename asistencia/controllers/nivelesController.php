...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_nivel == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'CARGO REGISTRADO');
                } else {
                    $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR');
                }
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'EL CARGO YA EXISTE');
            }
        } else {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'CARGO MODIFICADO');
                } else {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'CARGO ELIMINADO');
        } else {
