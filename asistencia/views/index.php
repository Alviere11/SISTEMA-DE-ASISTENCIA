...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/imagenes/ban" />
...
<body>
    <img class="bg-video" src="<?php echo RUTA . 'assets/images/polle1.png'; ?>" alt="">
    <!-- Masthead-->
    <div class="masthead">
        <div class="masthead-content text-white">
            <div class="container-fluid px-lg-0">
                ...
                <h1 class="fst-italic lh-1 mb-4">POLLERIA LEÑA AZUL</h1>
                <p class="mb-5">Entradas y salidas del personal</p>
                <form id="contactForm" autocomplete="off">
                    <!-- Email address input-->
                    <div class="row input-group-newsletter">
                        <div class="col"><input class="form-control" id="codigo" name="codigo" type="number" placeholder="Ingrese dni" /></div>
