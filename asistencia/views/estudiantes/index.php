            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="codigo">Dni <span class="text-danger">*</span></label>
                        <input id="codigo" class="form-control" type="text" name="codigo" placeholder="dni">
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="carrera">Turno <span class="text-danger">*</span></label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="nivel">Cargo <span class="text-danger">*</span></label>
